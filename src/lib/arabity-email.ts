...
افتح اللينك من الموبايل أو الكمبيوتر، واستخدم عربيتي على طول. مفيش تسجيل دخول ولا اشتراك شهري، والنظام شغال بالعربي ومن اليمين لليسار.
...
ده نفس عربيتي اللي على الموقع، بس ملف تنزّله على جهازك وتفتحه وتبدأ تسجّل فيه كل خطواتك. البيانات بتتحفظ على الجهاز، ومش محتاج نت بعد التحميل.
...
لو عايز نفس السيستم أوفلاين على الكمبيوتر: نزّل ملف HTML بتاع السيستم من الدرايف وافتحه.
لو عايزه على الموبايل: افتح فولدر الدرايف، اقرأ ملف الدليل، وبعدين ثبّت ملف الأندرويد.
لو حابب تفهم السيستم الأول: افتح ملف الدليل من نفس الفولدر.
